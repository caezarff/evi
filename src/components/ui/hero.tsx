...
const SUB =
  "Sou evi, fotógrafa. Cada imagem tem um pouco de mim e muito de você.";
...
function StackSpreadStage({
  ...
  useMotionValueEvent(progress, "change", (p) => {
    ...
    setCtaActive(p >= textFadeStart + 0.35);
  });
  ...
  const footerOpacity = useTransform(progress, [0.88, 1], [0, 1]);
    ...
    >
      <div className="sticky top-0 h-dvh w-full overflow-hidden">
        ...
        >
          ...
          >
            Sua história,
            <span className="opacity-60"> meu olhar.</span>
          </h1>
          <p
          ...
          <div
            className="mt-7 flex flex-wrap items-center justify-center gap-3 max-md:mt-6"
          ...
          >
            <Button
              ...
              nativeButton={false}
              role="link"
              render={<a href={contactHref}>Contato</a>}
            ...
            <Button
              ...
              nativeButton={false}
              role="link"
              render={<Link href="/gallery">Galeria</Link>}
              tabIndex={ctaActive ? 0 : -1}
            />
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          aria-hidden={!spread}
        >
          <SiteFooter backgroundColor={bgColor} interactive={spread} />
        </motion.div>
      </div>
    </section>
  );
